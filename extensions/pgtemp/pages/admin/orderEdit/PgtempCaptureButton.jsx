...
export default function PgtempCaptureButton({
  captureAPI,
  ...
  return (
    <RenderIfTrue
      condition={
        paymentStatus.code === 'authorized' && paymentMethod === 'pgtemp'
      }
    >
      <Card.Session>
...
export const query = `
  query Query {
    captureAPI: url(routeId: "capturePgtempPaymentIntent")
