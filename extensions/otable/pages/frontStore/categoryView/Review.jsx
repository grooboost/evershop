...
export default function Review({ review }) {
  return (
    <div className="review-card col-span-1">
      <div style={{ height: '300px', backgroundColor: '#e0e0e0'}}></div>
      <div className="review-card-inner" style={{ color: '#3a3a3a'}}>
        ...
        <div className="flex gap-4">
          ...
          <div style={{ fontWeight: '400', color: '#6b7280' }}>{maskName(review.customerName)}</div>
          <div style={{ fontWeight: '200', color: '#6b7280' }}>{formatDate(review.createdAt)}</div>
        </div>
