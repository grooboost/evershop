...
const HomeSchedule = () => {
  	return (
    		<div style={{width: "100%", position: "relative", backgroundColor: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", padding: "72px 0px", boxSizing: "border-box", textAlign: "left", fontSize: "14px", color: "#ff6741", fontFamily: "Pretendard",}}>
      			<div style={{width: "100%", height: "276px", display: "flex", flexDirection: "row", alignItems: "flex-start", justifyContent: "center", padding: "0px 10px", gap: "24px", maxWidth: "944px",}}>
        				...
        				<div style={{alignSelf: "stretch", width: "621.3px", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "flex-start", gap: "24px", color: "#6b7280",}}>
          					...
          					<div style={{width: "621.3px", boxShadow: "4px 4px 8px rgba(0, 0, 0, 0.15)", borderRadius: "10px", backgroundColor: "#3a3a3a", height: "74px", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "10px", textAlign: "center", fontSize: "18px", color: "#fff",}}>
