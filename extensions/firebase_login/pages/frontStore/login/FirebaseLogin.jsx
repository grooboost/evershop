...
function FirebaseLogin({ kauthUrl, aauthUrl, nauthUrl, gauthUrl, loginEmailUrl }) {
  return (
    <div>
      ...
      <div className='firebase__login__buttons_wrapper'>
        ...
        <span className="firebase__login__button_small">|</span>
        <a href={loginEmailUrl} className="firebase__login__button_small">
          <EmailIcon />
          {`이메일`}
        </a>
      </div>
...
export const query = `
  query Query {
    ...
    loginEmailUrl: url(routeId: "loginEmail")
  }
`;
