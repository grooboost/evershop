...
function Images({ id, images, addImage, removeImage, reviewImageUploadUrl }) {
  return (
...
export default function ReviewMediaManager({
  reviewImages = [],
  id,
  reviewImageUploadUrl
}) {
  const [images, setImages] = React.useState(reviewImages);
  ...
  return (
    <div className="review-image-manager">
      <Images
        id={id}
        images={images}
        addImage={addImage}
