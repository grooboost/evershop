...
export default function NpayCaptureButton({
  captureAPI,
  ...
  return (
    <RenderIfTrue
      condition={
        paymentMethod === 'npay' && paymentStatus.code === 'authorized'
      }
    >
      <Card.Session>
...
export const query = `
  query Query {
    captureAPI: url(routeId: "npayCaptureAuthorizedPayment")
